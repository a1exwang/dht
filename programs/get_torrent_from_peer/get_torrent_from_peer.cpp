...
int main (int argc, char **argv) {
  ...
  albert::log::initialize_logger(argc >= 4);
...
//  });
  ...
  auto target = u160::U160::from_hex("207674362039a82f6c1abd25e75c687dfc5f41bd");
  std::vector<uint8_t> metadata;
  std::vector<int> piece_ok;
  std::shared_ptr<albert::bt::peer::PeerConnection> pc = std::make_shared<albert::bt::peer::PeerConnection>(
      ...
      [&metadata, &piece_ok](int piece, size_t size) {
